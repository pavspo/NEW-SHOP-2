    ...
    public function editAction(){
        if(!empty($_POST)){
            ...
            $product->attributes['hit'] = $product->attributes['hit'] ? '1' : '0';
							if($product->attributes['available'] == 1):
							$product->attributes['available'] = 1;
						elseif($product->attributes['available'] == 2):
							$product->attributes['available'] = 2;						
						elseif($product->attributes['available'] == 3):
							$product->attributes['available'] = 3;
						endif;			
