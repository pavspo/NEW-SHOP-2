                ...
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator">
                    <div class="box-body">
						...
						<div class="form-group has-feedback">
                            ...
                            <input type="text" name="articul" class="form-control" id="articul" placeholder="Артикул" value="<?=h($product->articul);?>">
                        </div>
						<div class="form-group has-feedback">
                            <label for="title">Сортировка</label>
                            <input type="text" name="sort" class="form-control" id="sort" value="<?=h($product->sort);?>">
                        </div>						
...
<!------------------------------------------>
                        <div class="form-group has-feedback">
                            <label for="anons">Описание анонса</label>
                           <textarea name="anons" id="editor2" cols="40" rows="4"><?=$product->anons;?></textarea>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="parameter">Список свойств</label>
                           <textarea name="parameter" id="editor3" cols="40" rows="4"><?=$product->parameter;?></textarea>
                        </div>						
<!------------------------------------------>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="form-group">
							<!--<input type="radio" id="av_1" checked><label for="av_1">В наличии</label>
							<input type="radio" id="av_2" ><label for="av_2">На складе</label>
							<input type="radio" id="av_3" ><label for="av_3">Нет в наличии</label>-->
							<label><input type="radio" name="available" value="1"  checked> В наличии</label><br>
							<label><input type="radio" name="available" value="2"> На складе</label><br>
							<label><input type="radio" name="available" value="3"> Нет в наличии</label>
                        </div>
                        <div class="form-group">
